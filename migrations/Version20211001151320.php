...
final class Version20211001151320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        //$this->addSql('ALTER TABLE routes CHANGE area_id area_id INT NOT NULL, CHANGE rock_id rock_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        //$this->addSql('ALTER TABLE routes CHANGE area_id area_id INT NOT NULL, CHANGE rock_id rock_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE routes ADD CONSTRAINT FK_32D5C2B31871F89 FOREIGN KEY (rock_id) REFERENCES rock (id)');
        $this->addSql('ALTER TABLE routes ADD CONSTRAINT FK_32D5C2B3F28ED68D FOREIGN KEY (area_id) REFERENCES area (id)');
