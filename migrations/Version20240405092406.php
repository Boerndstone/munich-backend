 ...
 */
final class Version20240405092406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE area CHANGE header_image header_image VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE area CHANGE header_image header_image VARCHAR(25) DEFAULT NULL');
    }
}
