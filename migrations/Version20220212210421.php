...
final class Version20220212210421 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD first_name VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP password, CHANGE email email VARCHAR(180) NOT NULL COLLATE `utf8mb4_unicode_ci`');
