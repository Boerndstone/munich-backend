 ...
 */
final class Version20220212210421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD password VARCHAR(255) NOT NULL, DROP firstname');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD firstname VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP password, CHANGE email email VARCHAR(180) NOT NULL COLLATE `utf8mb4_unicode_ci`');
